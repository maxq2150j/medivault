...
const DoctorLogin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (role !== 'DOCTOR') {
                toast.error('Invalid role. Please login as a doctor.');
                return;
            }

            if (!specificId || specificId === '0' || specificId === 0) {
                console.error('[DoctorLogin] Invalid specialId:', specificId);
                toast.error('Server did not return valid doctor ID. Contact support.');
                return;
            }
            ...
            console.log('[DoctorLogin] Stored doctorId in sessionStorage:', sessionStorage.getItem('doctorId'));
