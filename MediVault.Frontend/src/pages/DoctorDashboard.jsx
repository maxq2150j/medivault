...
const DoctorDashboard = () => {
    ...
    const searchPatient = async (e) => {
        ...
        try {
            console.log('[DoctorDashboard] Searching for patient:', searchQuery);
            const res = await api.get(`/doctor/search-patients?query=${encodeURIComponent(searchQuery)}`);
    ...
    const generateConsultationReport = async (e) => {
        ...
        try {
            ...
            await api.post('/doctor/submit-consultation', {
